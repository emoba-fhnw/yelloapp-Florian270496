...
=== Zusatz-Merkmale
* Styling mit adaptiertem MaterialTheme (Typography.kt, Sizes.kt, Colors in Theme.kt)
* Design in Figma erstellt:
** image:whole_UI_v3.png[Figma_Prototype, 500]
* Umsetzung in der effektiven Android-App:
** image:YelloApp_final.jpg[Android_App, 500]
